...
public class BuildingSubUsageDetails extends AbstractAuditable {
    ...
    private transient List<SubOccupancy> subUsagesTemp;
    ...
    public List<SubOccupancy> getSubUsages() {
        return subUsages;
    }

    public void setSubUsages(List<SubOccupancy> subUsages) {
        this.subUsages = subUsages;
    }

    public List<SubOccupancy> getSubUsagesTemp() {
        return subUsagesTemp;
    }

    public void setSubUsagesTemp(List<SubOccupancy> subUsagesTemp) {
        this.subUsagesTemp = subUsagesTemp;
    }

    public String getSubUsageNames() {
        return subUsages.stream().map(SubOccupancy::getDescription).collect(Collectors.joining(", "));
    }
}
