...
public class BpaApplicationValidationService {
    ...
    public Map<String, String> checkIsViolatingCoverageArea(final BpaApplication application) {
        ...
        for (Entry<String, BigDecimal[]> floorDescSet : floorMap.entrySet()) {
            ...
            plinthArea.divide(extentInSqmts, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100));
    ...
    public Boolean isEdcrInetgrationRequired(final String serviceType) {
        /*
         * List<String> edcrRequiredService = getEdcrRequiredServices().get(serviceType); return edcrRequiredService == null ||
         * StringUtils.isBlank(occupancy) || !edcrRequiredService.contains(occupancy) ? false : true;
         */
