...
public class OccupancyCertificate extends StateAware<Position> {
    ...
    @OneToMany(mappedBy = "oc", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    private List<OcNocVerification> ocNocVerifications = new ArrayList<>();
    ...
    private transient OcNocVerification ocNocVerificationTemp;
    ...
    public List<OcNocVerification> getOcNocVerifications() {
        return ocNocVerifications;
    }

    public void setOcNocVerifications(List<OcNocVerification> ocNocVerifications) {
        this.ocNocVerifications = ocNocVerifications;
    }

    public OcNocVerification getOcNocVerificationTemp() {
        return ocNocVerificationTemp;
    }

    public void setOcNocVerificationTemp(OcNocVerification ocNocVerificationTemp) {
        this.ocNocVerificationTemp = ocNocVerificationTemp;
    }
