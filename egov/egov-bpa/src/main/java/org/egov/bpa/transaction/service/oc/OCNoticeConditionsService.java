...
public class OCNoticeConditionsService {
    ...
    public List<OCNoticeConditions> findAllOcConditionsByOcAndType(OccupancyCertificate oc,
            PermitConditionType type) {
        return ocNoticeConditionsRepository.findByOcAndTypeOrderByOrderNumberAsc(oc, type);
    }

    @Transactional
    public void delete(List<OCNoticeConditions> ocNoticeConditions) {
        ocNoticeConditionsRepository.deleteInBatch(ocNoticeConditions);
    }
