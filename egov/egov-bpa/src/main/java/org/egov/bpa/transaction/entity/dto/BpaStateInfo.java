...
public class BpaStateInfo {
    ...
    public Long getNocInitiatorPos() {
        return nocInitiatorPos;
    }

    public void setNocInitiatorPos(Long nocInitiatorPos) {
        this.nocInitiatorPos = nocInitiatorPos;
    }
