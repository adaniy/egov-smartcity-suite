...
public class ExistingBuildingDetail extends AbstractAuditable {
    ...
    public void setExistingBuildingFloorDetailsUpdate(List<ExistingBuildingFloorDetail> existingBuildingFloorDetailsUpdate) {
    ...
    public void setExistingBldgFloorDetailsFromEdcr(List<ExistingBuildingFloorDetail> existingBldgFloorDetailsFromEdcr) {
