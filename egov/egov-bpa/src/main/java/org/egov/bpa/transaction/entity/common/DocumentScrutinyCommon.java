...
@SequenceGenerator(name = DocumentScrutinyCommon.SEQ, sequenceName = DocumentScrutinyCommon.SEQ, allocationSize = 1)
public class DocumentScrutinyCommon extends AbstractAuditable {

    public static final String SEQ = "SEQ_EGBPA_DOCUMENT_SCRUTINY_COMMON";
