...
public class SiteDetail extends AbstractAuditable {
    ...
    private BigDecimal developedLandArea;
    private BigDecimal heightOfTowerOrPole;
    @ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL)
    ...
    public BigDecimal getDevelopedLandArea() {
        return developedLandArea;
    }

    public void setDevelopedLandArea(BigDecimal developedLandArea) {
        this.developedLandArea = developedLandArea;
    }

    public BigDecimal getHeightOfTowerOrPole() {
        return heightOfTowerOrPole;
    }

    public void setHeightOfTowerOrPole(BigDecimal heightOfTowerOrPole) {
        this.heightOfTowerOrPole = heightOfTowerOrPole;
    }
