...
public class RescheduleAppointmentForOcService {
    ...
    @Transactional
    public OCSlot rescheduleAppointmentsForOcByCitizen(Long applicationId, Date rescheduleAppointmentDate,
        ...
        SlotDetail slotDet = slotDetailRepository.findByAppointmentDateTimeAndZone(rescheduleAppointmentDate,
                appointmentTime, occupancyCertificate.getParent().getSiteDetail().get(0).getAdminBoundary().getParent(),
