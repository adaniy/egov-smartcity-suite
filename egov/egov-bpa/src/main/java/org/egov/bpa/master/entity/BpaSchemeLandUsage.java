...
public class BpaSchemeLandUsage extends AbstractAuditable {
    ...
    @Id
    @GeneratedValue(generator = SEQ_EGBPA_MSTR_SCHEMELANDUSAGE, strategy = GenerationType.SEQUENCE)
    private Long id;

    @ManyToOne(fetch = FetchType.LAZY)
    @NotNull
    @JoinColumn(name = "bpaScheme")
    ...
    public BpaScheme getBpaScheme() {
        return bpaScheme;
    }

    public void setBpaScheme(BpaScheme bpaScheme) {
