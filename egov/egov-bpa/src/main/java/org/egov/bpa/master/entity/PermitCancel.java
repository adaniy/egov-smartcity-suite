...
@Entity
@Table(name = "EGBPA_PERMIT_CANCEL")
...
public class PermitCancel extends AbstractAuditable {
    ...
    */
    ...
    @Id
    @GeneratedValue(generator = SEQ_CANCEL, strategy = GenerationType.SEQUENCE)
    private Long id;
    ...
    @JoinTable(name = "egbpa_permit_cancel_document", joinColumns = @JoinColumn(name = "permitCancel"), inverseJoinColumns = @JoinColumn(name = "fileStore"))
    private Set<FileStoreMapper> cancelSupportDocs = new HashSet<>();
    ...
    public Set<FileStoreMapper> getCancelSupportDocs() {
        return cancelSupportDocs;
    }

    public void setCancelSupportDocs(Set<FileStoreMapper> cancelSupportDocs) {
        this.cancelSupportDocs = cancelSupportDocs;
    }
