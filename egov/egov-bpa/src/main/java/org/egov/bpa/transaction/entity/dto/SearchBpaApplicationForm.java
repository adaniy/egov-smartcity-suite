...
public class SearchBpaApplicationForm extends DataTableSearchRequest {
    ...
    public SearchBpaApplicationForm(BpaApplication application, String currentOwner, String pendingAction,
        ...
        setOccupancy(application.getOccupancy() == null ? "N/A" : application.getOccupancy().getDescription());
        ...
        if (!application.getRevocations().isEmpty())
            for (PermitRevocation revoke : application.getRevocations())
                if (revoke.getRevocationNumber() != null)
                    setRevocationNumber(revoke.getRevocationNumber());
    }
    ...
    public boolean isReqularized() {
        return isReqularized;
    }

    public void setReqularized(boolean isReqularized) {
        this.isReqularized = isReqularized;
    }
