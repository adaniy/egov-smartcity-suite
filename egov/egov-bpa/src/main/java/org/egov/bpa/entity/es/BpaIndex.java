...
public class BpaIndex {
    ...
    public Date getPermitCancelDate() {
        return permitCancelDate;
    }

    public void setPermitCancelDate(Date permitCancelDate) {
        this.permitCancelDate = permitCancelDate;
    }
