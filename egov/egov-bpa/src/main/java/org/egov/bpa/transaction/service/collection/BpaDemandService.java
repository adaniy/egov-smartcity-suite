...
public class BpaDemandService {
    ...
    public ApplicationFee generateDemandUsingSanctionFeeList(ApplicationFee applicationFee) {
        ...
        for (ApplicationFeeDetail applicationFeeDtl : applicationFee.getApplicationFeeDetail())
            ...
            } else if (null != feecodedemanddetailsIdmap.get(applicationFeeDtl.getBpaFee().getCode()))
    ...
    @Transactional
    public EgDemand generateDemandUsingSanctionFeeList(ApplicationFeeCommon applicationFeeCommon, EgDemand demand) {
