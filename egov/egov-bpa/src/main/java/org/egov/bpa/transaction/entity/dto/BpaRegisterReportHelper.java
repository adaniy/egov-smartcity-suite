...
public class BpaRegisterReportHelper {
    ...
    public Date getOcApprovalDate() {
        return ocApprovalDate;
    }

    public void setOcApprovalDate(Date ocApprovalDate) {
        this.ocApprovalDate = ocApprovalDate;
    }
