...
public class PlanScrutinyChecklistService {

    @Autowired
    private PlanScrutinyChecklistRepository planScrutinyChecklistRepository;

    public List<PlanScrutinyChecklist> findByInspectionAndScrutinyChecklistType(final Inspection inspection,
    ...
    public void delete(List<PlanScrutinyChecklist> planScrutinyChecklists) {
