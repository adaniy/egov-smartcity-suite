...
public class CheckListDetailService {
    ...
    public List<CheckListDetail> findActiveCheckListByChecklistTypeAndOrderById(final String checklistType) {
        return checkListDetailRepository.findActiveCheckListByChecklistTypeOrderById(checklistType);
    }
}