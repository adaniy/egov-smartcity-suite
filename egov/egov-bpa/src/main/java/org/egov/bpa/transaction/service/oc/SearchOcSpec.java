...
public class SearchOcSpec {
    ...
    public static Specification<OccupancyCertificate> search(final SearchBpaApplicationForm requestForm) {
        return (root, query, builder) -> {
            ...
            if (requestForm.getOccupancyCertificateNumber() != null)
                predicate.getExpressions()
                        .add(builder.equal(root.get("occupancyCertificateNumber"), requestForm.getOccupancyCertificateNumber()));
            if (requestForm.getPlanPermissionNumber() != null)
                predicate.getExpressions()
                        .add(builder.equal(bpaApplication.get("planPermissionNumber"), requestForm.getPlanPermissionNumber()));
            ...
            if (requestForm.getFromBuiltUpArea() != null)
                predicate.getExpressions()
                        .add(builder.greaterThanOrEqualTo(bpaApplication.get("totalBuiltUpArea"),
                                requestForm.getFromBuiltUpArea()));
