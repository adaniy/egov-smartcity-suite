    ...
    public JsonElement serialize(final DataTable<SearchBuildingPlanScrutinyForm> planScrutinyReportResponse, final Type type,
        ...
        psrResult.forEach(baseForm -> {
            ...
            jsonObject.addProperty("applicationNumber",
                    isBlank(baseForm.getApplicationNumber()) ? N_A : baseForm.getApplicationNumber());
            jsonObject.addProperty("buildingPlanScrutinyNumber",
                    isBlank(baseForm.getBuildingPlanScrutinyNumber()) ? N_A : baseForm.getBuildingPlanScrutinyNumber());
            ...
            jsonObject.addProperty("markedDxfFileStoreId",
                    isBlank(baseForm.getMarkedDxfFileStoreId()) ? N_A : baseForm.getMarkedDxfFileStoreId());
            jsonObject.addProperty("markedDxfFileName",
                    isBlank(baseForm.getMarkedDxfFileName()) ? N_A : baseForm.getMarkedDxfFileName());
            jsonObject.addProperty("reportOutputFileStoreId",
                    isBlank(baseForm.getReportOutputFileStoreId()) ? N_A : baseForm.getReportOutputFileStoreId());
            jsonObject.addProperty("reportOutputFileName",
                    isBlank(baseForm.getReportOutputFileName()) ? N_A : baseForm.getReportOutputFileName());
            jsonObject.addProperty("status", isBlank(baseForm.getStatus()) ? N_A : baseForm.getStatus());
            jsonObject.addProperty("bpaApplicationNumber",
                    isBlank(baseForm.getBpaApplicationNumber()) ? N_A : baseForm.getBpaApplicationNumber());
            jsonObject.addProperty("permitNumber", isBlank(baseForm.getPermitNumber()) ? N_A : baseForm.getPermitNumber());
            jsonObject.addProperty("buildingLicenceeType",
                    isBlank(baseForm.getBuildingLicenceeType()) ? N_A : baseForm.getBuildingLicenceeType());
            jsonObject.addProperty("buildingLicenceeName",
                    isBlank(baseForm.getBuildingLicenceeName()) ? N_A : baseForm.getBuildingLicenceeName());
