        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label text-right"> <spring:message
                                code="lbl.bpaapplicationnumber"/>
                        </label>
                        <div class="col-sm-3 add-margin">
                            <form:input type="text"
                                        cssClass="form-control inline-elem patternvalidation"
                                        path="bpaApplicationNumber"
                                        id="bpaApplicationNumber" maxlength="20"/>
                            <form:errors path="bpaApplicationNumber"
                                         cssClass="error-msg"/>
                        </div>
                        <label class="col-sm-2 control-label text-right"> <spring:message
                                code="lbl.dcrnumber"/>
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <table class="table table-bordered nowrap table-hover multiheadertbl display"
                           id="planScrutinyId" style="overflow-x: auto;max-width: 100%;min-width: 100%;">
            <thead>
            <tr>
                ...
                <th><spring:message code="lbl.dxf.marked.doc"/></th>
                <th><spring:message code="lbl.dcr.report.ouput"/></th>
                <th><spring:message code="lbl.status"/></th>
                <th><spring:message code="lbl.buildinglicensee.type"/></th>
                <th><spring:message code="lbl.buildinglicensee.name"/></th>
                <th><spring:message code="lbl.bpaapplicationnumber"/></th>
                <th><spring:message code="lbl.permitnumber"/></th>
            </tr>
            </thead>
                    </table>
                </div>
