...
import static org.egov.edcr.utility.ParametersConstants.EXISTING_FLOOR_AREA;
import static org.egov.edcr.utility.ParametersConstants.EXISTING_FLOOR_AREA_TO_BE_DEMOLISHED;
import static org.egov.edcr.utility.ParametersConstants.FLOOR_AREA;
import static org.egov.edcr.utility.ParametersConstants.GOVERNMENT_OR_AIDED_ORGANIZATION;
...
@Service
public class MeanOfAccess extends GeneralRule implements RuleService {
    ...
    public List<String> getParameters() {
        ...
        parameters.add(GOVERNMENT_OR_AIDED_ORGANIZATION);
        parameters.add(EXISTING_FLOOR_AREA);
        parameters.add(EXISTING_FLOOR_AREA_TO_BE_DEMOLISHED);
        return parameters;
    }
    ...
    public PlanDetail process(PlanDetail pl) {
        ...
        if (!extemption) {
            ...
            if (pl.getVirtualBuilding() != null && !pl.getVirtualBuilding().getOccupancies().isEmpty())
                if (pl.getVirtualBuilding().getOccupancies().stream()
                        .anyMatch(occupancyType -> !(occupancyType.equals(OccupancyType.OCCUPANCY_B1)
                                || occupancyType.equals(OccupancyType.OCCUPANCY_B2))))
                    // occupancies present are other than B1 and B2.
                    for (OccupancyType occupancy : pl.getVirtualBuilding().getOccupancies()) {
                        ...
                        if (occupancy.equals(OccupancyType.OCCUPANCY_A1) || occupancy.equals(OccupancyType.OCCUPANCY_A4)
                                || occupancy.equals(OccupancyType.OCCUPANCY_A5)) {
                            if (totalFloorAreaOfAllBlocks.compareTo(VAL_300) <= 0) {
                                ...
                                if (occupancy.equals(OccupancyType.OCCUPANCY_A1))
                                    break;
                                else
                            ...
                            subRule = SUBRULE_33_1;
                        } else if (occupancy.equals(OccupancyType.OCCUPANCY_A2) || occupancy.equals(OccupancyType.OCCUPANCY_A3) ||
                                occupancy.equals(OccupancyType.OCCUPANCY_B1) || occupancy.equals(OccupancyType.OCCUPANCY_B2) ||
                                occupancy.equals(OccupancyType.OCCUPANCY_B3) || occupancy.equals(OccupancyType.OCCUPANCY_C) ||
                                occupancy.equals(OccupancyType.OCCUPANCY_C1) || occupancy.equals(OccupancyType.OCCUPANCY_C2) ||
                                occupancy.equals(OccupancyType.OCCUPANCY_C3) || occupancy.equals(OccupancyType.OCCUPANCY_D) ||
                                ...
                                occupancy.equals(OccupancyType.OCCUPANCY_F1) || occupancy.equals(OccupancyType.OCCUPANCY_F2) ||
                                occupancy.equals(OccupancyType.OCCUPANCY_F3) || occupancy.equals(OccupancyType.OCCUPANCY_F4)) {
                            if (occupancy.equals(OccupancyType.OCCUPANCY_B3) && pl.getParkingRequired() > 0
                                ...
                                minimumAccessWidth = BigDecimal.valueOf(10);
                            subRule = SUBRULE_33_1;
                        } else if (occupancy.equals(OccupancyType.OCCUPANCY_G1) || occupancy.equals(OccupancyType.OCCUPANCY_G2)) {
                            if (totalFloorAreaOfAllBlocks.compareTo(VAL_300) <= 0)
                                minimumAccessWidth = BigDecimal.valueOf(3);
                            else if (totalFloorAreaOfAllBlocks.compareTo(VAL_300) > 0
                                    && totalFloorAreaOfAllBlocks.compareTo(VAL_1500) <= 0)
                        ...
                        } else if (occupancy.equals(OccupancyType.OCCUPANCY_H)) {
                            minimumAccessWidth = BigDecimal.valueOf(7);
                            subRule = SUBRULE_58_3b;
                        } else if (occupancy.equals(OccupancyType.OCCUPANCY_I1) || occupancy.equals(OccupancyType.OCCUPANCY_I2)) {
                            minimumAccessWidth = BigDecimal.valueOf(7);
                    ...
                    String occupancyType = pl.getVirtualBuilding().getOccupancies().contains(OccupancyType.OCCUPANCY_B2)
                            ? OccupancyType.OCCUPANCY_B2.getOccupancyTypeVal()
                            : OccupancyType.OCCUPANCY_B1.getOccupancyTypeVal();
                ...
                if (valid) {
                    pl.reportOutput
                            .add(buildRuleOutputWithSubRule(rule,
                                    (String) mapOfFinalAccessWidthValues.get("subRule"),
                                    String.format(SUB_RULE_DESCRIPTION, mapOfFinalAccessWidthValues.get(OCCUPANCY)),
                                    String.format(SUB_RULE_DESCRIPTION, mapOfFinalAccessWidthValues.get(OCCUPANCY)),
                                    mapOfFinalAccessWidthValues.get("minAccessWidth") + DcrConstants.IN_METER,
                                    pl.getPlanInformation().getAccessWidth() +
