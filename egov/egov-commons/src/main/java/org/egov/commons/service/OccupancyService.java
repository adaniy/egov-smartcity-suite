...
import org.egov.commons.repository.SubOccupancyRepository;
...
public class OccupancyService {
    ...
    public List<SubOccupancy> findSubUsagesByOccupancy(final String occupancy) {
        return subOccupancyRepository
                .findByOccupancyAndIsActiveTrueOrderByOrderNumberAsc(occupancyRepository.findByDescription(occupancy));
    }
