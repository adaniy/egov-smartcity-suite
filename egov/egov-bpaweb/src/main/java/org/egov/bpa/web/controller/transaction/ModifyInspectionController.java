...
public class ModifyInspectionController extends BpaGenericApplicationController {
    ...
    public Inspection getInspectionForBpaApplication(@PathVariable final String applicationNumber) {
        ...
        final List<Inspection> inspections = inspectionService
    ...
    private void loadApplication(final Model model, final BpaApplication application) {
        ...
        inspection.setPlanScrutinyChecklistTemp(planScrutinyChecklistService.findByInspectionAndScrutinyChecklistType(inspection,
                ScrutinyChecklistType.RULE_VALIDATION));
        if (inspection.getPlanScrutinyChecklistTemp().isEmpty())
            inspection.setPlanScrutinyChecklist(planScrutinyChecklistService.findByInspectionAndScrutinyChecklistType(inspection,
                    ScrutinyChecklistType.COMBINED));
        inspection.setPlanScrutinyChecklistForDrawingTemp(planScrutinyChecklistService
                .findByInspectionAndScrutinyChecklistType(inspection, ScrutinyChecklistType.DRAWING_DETAILS));
    }
