...
public class SearchPersonalRegisterAdaptor implements JsonSerializer<PersonalRegisterHelper> {
    ...
    public JsonElement serialize(final PersonalRegisterHelper searchFormObj, final Type type,
        ...
        if (searchFormObj != null) {
            ...
            jsonObject.addProperty("totalFloorArea",
                    searchFormObj.getTotalFloarArea() == null ? N_A : String.valueOf(searchFormObj.getTotalFloarArea()));
            jsonObject.addProperty("noOfFloars",
                    searchFormObj.getNoOfFloors() == null ? N_A : String.valueOf(searchFormObj.getNoOfFloors()));
            jsonObject.addProperty("far",
                    searchFormObj.getFar() != null && searchFormObj.getFar().compareTo(BigDecimal.ZERO) == 0 ? N_A
                            : String.valueOf(searchFormObj.getFar()));
            ...
            jsonObject.addProperty("previousDateAndTime", searchFormObj.getPreviousDateAndTime() != null
                    ? formatter("dd/MM/yyyy hh:mm a").print(new DateTime(searchFormObj.getPreviousDateAndTime(), jodaTimeZone()))
                    : N_A);
            ...
            jsonObject.addProperty("nextDateAndTime", searchFormObj.getNextDateAndTime() != null
                    ? formatter("dd/MM/yyyy hh:mm a").print(new DateTime(searchFormObj.getNextDateAndTime(), jodaTimeZone()))
                    : N_A);
