...
import static org.egov.bpa.utils.OcConstants.OCDEMANDFILENAME;
...
public class BpaNoticeController {
    ...
    @ResponseBody
    public ResponseEntity<InputStreamResource> generateOccupancyCertificateRejectionNotice(
            @PathVariable final String applicationNumber) throws IOException {
        OccupancyCertificateNoticesFormat ocNoticeFeature = (OccupancyCertificateNoticesFormat) specificNoticeService
    ...
    @ResponseBody
    public ResponseEntity<InputStreamResource> generateOccupancyCertificateDemandNotice(
