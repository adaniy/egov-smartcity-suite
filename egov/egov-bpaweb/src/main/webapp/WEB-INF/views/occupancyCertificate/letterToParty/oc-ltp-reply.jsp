...
<form:form role="form" action=""
           method="post" modelAttribute="ocLetterToParty" id="lettertoPartyReplyform"
           cssClass="form-horizontal form-groups-bordered"
           enctype="multipart/form-data">
    <form:hidden path="id" value="${ocLetterToParty.id}"/>
    <input type="hidden" name="ocLetterToParty" value="${ocLetterToParty.id}">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    <div class="row add-border">
                        ...
                        <div class="col-sm-3 add-margin view-content">
                            <c:out value="${ocLetterToParty.letterToParty.lpNumber}"></c:out>
                        </div>
                        <div class="col-sm-2 add-margin">
                            <spring:message code="lbl.letterdate"/>
                        </div>
                        <div class="col-sm-3 add-margin view-content">
                            <fmt:formatDate value="${ocLetterToParty.letterToParty.letterDate}" pattern="dd/MM/yyyy"
                                            var="letterDate"/>
                    ...
                    <div class="row add-border">
                        ...
                        <div class="col-sm-9 add-margin  view-content">
                            <c:out value="${ocLetterToParty.letterToParty.lpDesc}"/>
                        </div>
                    </div>
