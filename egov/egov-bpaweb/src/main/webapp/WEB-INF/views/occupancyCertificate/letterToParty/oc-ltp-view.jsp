            ...
            <div class="panel-body">
                <div class="row add-border">
                    ...
                    <div class="col-sm-3 add-margin view-content">
                        <c:out value="${ocLetterToParty.letterToParty.lpNumber}" default="N/A"></c:out>
                    </div>
                    ...
                    <div class="col-sm-3 add-margin view-content">
                        <fmt:formatDate value="${ocLetterToParty.letterToParty.sentDate}" pattern="dd/MM/yyyy"
                                        var="sentDate"/>
                        <c:out value="${sentDate}" default="N/A"></c:out>
                    </div>
                    <%-- </c:if> --%>
                    <input type="hidden" id='lettertoParty' name="ocLetterToParty"
                           value="${ocLetterToParty.letterToParty.id}">
                </div>
                <div class="row add-border">
                    <div class="col-sm-3 add-margin">
                    ...
                    <div class="col-sm-3 add-margin view-content">
                        <c:forEach items="${ocLetterToParty.letterToParty.lpReason}" var="lpReason"
                                   varStatus="status">
                ...
                <div class="row add-border">
                    ...
                    <div class="col-sm-9 add-margin view-content">
                        <c:out value="${ocLetterToParty.letterToParty.lpDesc}" default="N/A"></c:out>
                    </div>
                </div>

                <div class="row add-border">
                    <c:if test="${ocLetterToParty.letterToParty.replyDate !=null }">
                        <div class="col-sm-3 add-margin">
                            <spring:message code="lbl.lpreplydate"/>
                        </div>
                        <div class="col-sm-3 add-margin view-content">
                            <fmt:formatDate value="${ocLetterToParty.letterToParty.replyDate}" pattern="dd/MM/yyyy"
                                            var="replyDate"/>
                ...
                <div class="row add-border">
                    <c:if test="${ocLetterToParty.letterToParty.lpReplyRemarks !=null }">
                        <div class="col-sm-3 add-margin">
                            <spring:message code="lbl.lpReplyRemarks"/>
                        </div>
                        <div class="col-sm-9 add-margin view-content">
                            <c:out value="${ocLetterToParty.letterToParty.lpReplyRemarks}" default="N/A"></c:out>
                        </div>
                    </c:if>
                </div>
            </div>
