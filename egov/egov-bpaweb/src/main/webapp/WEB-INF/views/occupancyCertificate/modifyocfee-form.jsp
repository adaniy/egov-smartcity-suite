...
<div class="row">
	<div class="col-md-12">
		<form:form role="form" action="" method="post"
			...
			<form:hidden path="applicationFeeCommon.feeDate"/>
						...
						<div class="col-sm-3 add-margin">
							...
							<form:hidden path="applicationFeeCommon.status" id="feeapplicationstatusid"
								value="${occupancyFee.applicationFeeCommon.status.id}" />
									<form:hidden path="applicationFeeCommon" id="feeapplicationid"
								value="${occupancyFee.applicationFeeCommon.id}" />
							...
							<c:forEach var="docs"
								...
								<div class="form-group">
									...
									<div class="col-sm-5 add-margin check-text text-right">
										...
										<form:hidden
											id="applicationFeeDetail${status.index}applicationFeeCommon"
