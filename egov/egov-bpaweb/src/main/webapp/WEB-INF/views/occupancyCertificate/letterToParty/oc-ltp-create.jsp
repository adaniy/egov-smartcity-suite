...
<form:form role="form" action="" method="post"
           modelAttribute="ocLetterToParty" id="ocLettertoPartyform"
                ...
                <div class="panel-body">
                    <div class="row add-border">
                        <div class="form-group">
                            <form:hidden path="oc" id="occupancyCertificateId"
                        ...
                        <c:when test="${!checkListDetailList.isEmpty()}">
                            ...
                            <c:forEach var="docs" items="${checkListDetailList}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3 add-margin">
                                        <form:checkbox
                                                id="lettertoPartyDocument${status.index}requested"
...
<script
        src="<cdn:url value='/resources/js/app/occupancy-certificate/oc-letter-to-party.js?rnd=${app_release_no}'/> "></script>
