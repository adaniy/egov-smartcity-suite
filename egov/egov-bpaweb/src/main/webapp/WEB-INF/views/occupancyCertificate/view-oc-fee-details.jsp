...
<div class="panel-body">
    <c:if test="${!applicationFeeDetailCommon.isEmpty()}">
        <table class="table table-striped table-bordered" id="bpaChargesDetail" style="width:50%;margin:0 auto;">
            ...
            <c:forEach var="feeType" items="${occupancyCertificate.occupancyFee[0].applicationFeeCommon.applicationFeeDetailCommon}"
                       varStatus="counter">
                <tr>
    ...
    <c:if
            test="${occupancyCertificate.occupancyFee[0].applicationFeeCommon.modifyFeeReason ne null}">
        <div class="row add-border">
            ...
            <div class="col-sm-7 add-margin view-content text-justify">
                <c:out value="${occupancyCertificate.occupancyFee[0].applicationFeeCommon.modifyFeeReason}"/>
            </div>
        </div>
    </c:if>
</div>
