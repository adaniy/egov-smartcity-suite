...
<div class="panel-body">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label text-right"><spring:message code="lbl.work.commence.date"/> <span class="mandatory"></span>
		</label>
		<div class="col-sm-3 add-margin">
		...
		<label class="col-sm-2 control-label text-right"><spring:message code="lbl.work.completion.date"/><span class="mandatory"></span>
		</label>
		<div class="col-sm-3 add-margin">
