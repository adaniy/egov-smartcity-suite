...
<div class="row add-border">
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
		 	<fmt:formatNumber type="number" maxFractionDigits="2" value="${occupancyCertificate.extentInSqmts}" var="extentInSqmts"/>
			<c:out value="${extentInSqmts}" default="N/A"></c:out>
		</div>
	</div>
</div>
