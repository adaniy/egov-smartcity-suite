			...
			<ul class="nav nav-tabs" id="settingstab">
				...
				<c:if test="${not empty occupancyCertificate.getOcNocVerifications()}">
					<li><a data-toggle="tab" href="#view-noc-verify-dtls"
						   data-tabidx=7><spring:message code='lbl.noc.verify.dtl' /></a></li>
				</c:if>
			</ul>
			...
			<div class="buttonbottom" align="center">
				<table>
					<tr>
						...
						<c:if
							test="${(occupancyCertificate.status.code eq 'Rejected' || occupancyCertificate.status.code eq 'Cancelled') && occupancyCertificate.state ne null}">
							<td><a
