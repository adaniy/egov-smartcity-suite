...
<input type="hidden" id="dcrDocsAutoPopulate" name="dcrDocsAutoPopulate"
	value="${dcrDocsAutoPopulate}" />
<input type="hidden" id="dcrDocsManuallyUpload"
	name="dcrDocsManuallyUpload" value="${dcrDocsManuallyUpload}" />
<input type="hidden" id="dcrDocsAutoPopulateAndManuallyUpload"
	name="dcrDocsAutoPopulateAndManuallyUpload"
				...
				<div class="row">
					...
					<div class="col-sm-3 add-margin">
						<form:textarea class="form-control patternvalidation"
							...
							path="dcrDocuments[${dcrDocStatus.index}].dcrDocument.remarks"
							value="${dcrDoc.dcrDocument.remarks}" />
						<form:errors
							path="dcrDocuments[${dcrDocStatus.index}].dcrDocument.remarks"
							...
							<c:choose>
								<c:when
									...
									<div class="files-viewer ${checklistName}">
										<c:forEach items="${dcrDoc.dcrDocument.getOrderedDcrAttachments()}"
											var="file" varStatus="status1">
											<div class="file-viewer" data-toggle="tooltip"
												data-placement="top"
												title="${file.fileStoreMapper.fileName}">
								...
								<c:otherwise>
									<div class="files-viewer ${checklistName}">
										<form:hidden
											path="dcrDocuments[${dcrDocStatus.index}].dcrDocument.fileStoreIds"
											id="fileStoreIds" cssClass="${checklistName}_fileStoreIds"></form:hidden>
									</div>
								</c:otherwise>
							</c:choose>
						</div>
