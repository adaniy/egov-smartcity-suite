...
<form:form role="form" action="" method="post"
           modelAttribute="ocLetterToParty" id="ocLetterToPartyUpdateForm"
                ...
                <div class="panel-body">
                    <div class="row add-border">
                        ...
                        <%--<form:hidden path="letterToParty.letterDate" id="letterDate"
                                     value="${ocLetterToParty.letterToParty.letterDate}"/>--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 add-margin">
                                        ...
                                        <%--<div class="col-sm-2 add-margin text-center">
                                            <c:choose>
                                                <c:when test="${chk.isMandatory}">
                                                    <input type="file" id="file${status.index}id"
                                                        name="letterToParty.letterToPartyDocument[${status.index}].files"
                                            ...
                                            <form:errors
                                                path="letterToParty.letterToPartyDocument[${status.index}].files"
                                                cssClass="add-margin error-msg" />
                                        </div>--%>
