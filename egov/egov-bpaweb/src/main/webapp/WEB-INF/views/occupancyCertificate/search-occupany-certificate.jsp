				...
				<div class="panel-body">
					<div class="form-group">
						<label class="col-sm-3 control-label text-right"><spring:message
								code="lbl.regularize.appln" /></label>
						<div class="col-sm-3 add-margin">
							<form:checkbox path="reqularized" id="isReqularized" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label text-right"><spring:message
						...
						<label class="col-sm-2 control-label text-right"><spring:message
								code="lbl.oc.no" /></label>
						<div class="col-sm-3 add-margin">
							<form:input class="form-control patternvalidation" maxlength="50"
								id="occupancyCertificateNumber"
								path="occupancyCertificateNumber" />
							<form:errors path="occupancyCertificateNumber"
								cssClass="add-margin error-msg" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							<form:select path="statusId" data-first-option="false"
								id="statusId" cssClass="form-control serviceType">
								<form:option value="">
									<spring:message code="lbl.select" />
								</form:option>
						...
						<label class="col-sm-2 control-label text-right"><spring:message
								code="lbl.occupancy" /></label>
						<div class="col-sm-3 add-margin">
							<form:select path="occupancyId" data-first-option="false"
								id="occupancyId" cssClass="form-control serviceType">
								<form:option value="">
									<spring:message code="lbl.select" />
								</form:option>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 add-margin">
							...
							<form:errors path="electionWardId"
								cssClass="add-margin error-msg" />
						</div>
					</div>
					<div class="form-group plotAreaHideShow">
						...
						<div class="col-sm-3 add-margin">
							...
							<form:errors path="fromPlotArea" cssClass="add-margin error-msg" />
						</div>
						<label class="col-sm-2 control-label text-right"><spring:message
						...
						<div class="col-sm-3 add-margin">
							...
							<form:errors path="toPlotArea" cssClass="add-margin error-msg" />
						</div>
					</div>
					<div class="form-group builtUpAreaHideShow">
						...
						<div class="col-sm-3 add-margin">
							<form:input class="form-control patternvalidation"
								data-pattern="number" id="fromBuiltUpArea"
								path="fromBuiltUpArea" />
...
<script
	src="<cdn:url value='/resources/js/app/occupancy-certificate/searchOCappln.js?rnd=${app_release_no}'/> "></script>
