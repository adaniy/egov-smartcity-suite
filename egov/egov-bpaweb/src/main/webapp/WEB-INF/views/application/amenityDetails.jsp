...
<div class="form-group">
	...
	<div class="col-sm-3 add-margin">
		...
		<form:select path="siteDetail[0].unitOfMeasurement"
			...
			cssClass="form-control for-calculation dcr-calculation"
			required="required">
	...
	<div class="col-sm-3 add-margin">
		...
		<form:input
			class="form-control patternvalidation decimalfixed extentinsqmts"
...
<script id="poles-template" type="text/egov-template">
	...
	<div class="col-sm-3 add-margin">
		<form:input class="form-control patternvalidation dyn-mandatory nonzero Pole"
			...
			path="siteDetail[0].noOfPoles" required="required" value="1" readonly="true" />
...
<script id="tower-template" type="text/egov-template">
	...
	<div class="col-sm-3 add-margin">
		<form:input class="form-control patternvalidation dyn-mandatory nonzero Towe"
			...
			path="siteDetail[0].erectionoftower" required="required" value="1" readonly="true" />
...
<script id="developArea-template" type="text/egov-template">
	<label class="{className} control-label text-right toggle-madatory DevelopArea"><spring:message
			code="lbl.prop.area.develop" /><span class="mandatory"></span></label>
	<div class="col-sm-3 add-margin">
		<form:input class="form-control patternvalidation dyn-mandatory decimalfixed nonzero DevelopArea"
			data-pattern="decimalvalue" id="developedLandArea" maxlength="10"
			path="siteDetail[0].developedLandArea" required="required" />
		<form:errors path="siteDetail[0].developedLandArea"
			cssClass="add-margin error-msg" />
	</div>
</script>

<script id="towerPoleHeight-template" type="text/egov-template">
	<label class="{className} control-label text-right toggle-madatory towerPoleHeight">
<c:choose><c:when test="${bpaApplication.serviceType.code eq '14'}"><spring:message code="lbl.hgt.tower" /></c:when><c:otherwise><spring:message code="lbl.hgt.pole" /> </c:otherwise></c:choose>
 <span class="mandatory"></span></label>
	<div class="col-sm-3 add-margin">
		<form:input class="form-control patternvalidation dyn-mandatory decimalfixed nonzero towerPoleHeight"
			data-pattern="decimalvalue" id="heightOfTowerOrPole" maxlength="10"
			path="siteDetail[0].heightOfTowerOrPole" required="required" />
		<form:errors path="siteDetail[0].heightOfTowerOrPole"
			cssClass="add-margin error-msg" />
	</div>
</script>
