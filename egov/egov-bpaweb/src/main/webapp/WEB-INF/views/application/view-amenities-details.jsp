...
<script id="developArea-view-template" type="text/egov-template">
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.prop.area.develop" />
		</div>
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatNumber type="number" maxFractionDigits="2" value="${bpaApplication.siteDetail[0].developedLandArea}" />
		</div>
</script>

<script id="towerPoleHeight-view-template" type="text/egov-template">
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatNumber type="number" maxFractionDigits="2" value="${bpaApplication.siteDetail[0].heightOfTowerOrPole}" />
		</div>
</script>
