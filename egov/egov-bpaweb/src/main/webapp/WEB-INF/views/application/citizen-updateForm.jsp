	...
	<div class="col-md-12">
		<form:form role="form" modelAttribute="bpaApplication"
			...
			<input type="hidden" id="stakeHolderType"
				value="${bpaApplication.stakeHolder[0].getStakeHolder().getStakeHolderType().getStakeHolderTypeVal()}" />
			...
			<div class="tab-content">
				<div id="document-info" class="tab-pane fade">
					<div class="panel panel-primary" data-collapsed="0">
						<!-- <div class="dcrDocuments"> -->
							<c:if
								test="${bpaApplication.serviceType.planScrutinyDocumentsRequired eq true}">
				...
				<div id="appliccation-info" class="tab-pane fade in active">
					<c:choose>
						<c:when
							test="${bpaApplication.serviceType.occupancySelectionRequired eq true && bpaApplication.serviceType.amenitySelectionRequired eq true }">
							<div class="panel panel-primary" data-collapsed="0">
						...
						<c:otherwise>
							<div class="panel panel-primary" data-collapsed="0">
								<jsp:include page="applicationdetail-wo-oa.jsp"></jsp:include>
							</div>
						</c:otherwise>
					</c:choose>
					...
					<tr>
						<td><c:if test="${isReconciliationInProgress ne true}">
								<form:button type="submit" id="buttonSave"
									class="btn btn-primary" value="Save"> Save </form:button>
								<c:if
									...
									<form:button type="submit" id="buttonSubmit"
										class="btn btn-primary" value="Submit">Submit</form:button>
