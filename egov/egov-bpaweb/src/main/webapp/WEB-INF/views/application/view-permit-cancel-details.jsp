...
<div class="panel-heading custom_form_panel_heading">
	<div class="panel-title">
		<spring:message code="lbl.permit.cancel.details" />
	</div>
</div>
<div class="panel-body">
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatDate
				value="${bpaApplication.permitCancel.applicationDate}"
		...
		<div class="col-sm-3 add-margin view-content">
			<fmt:formatDate
				value="${bpaApplication.permitCancel.cancellationDate}"
				pattern="dd/MM/yyyy" var="cancellationDate" />
			<c:out value="${cancellationDate}" default="N/A"></c:out>
		</div>
	</div>
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-9 add-margin view-content">
			<c:out value="${bpaApplication.permitCancel.initiatorRemarks}"
				default="N/A"></c:out>
		</div>
	</div>
	<div class="row add-border">
		...
		<div class="col-sm-9 add-margin view-content">
			<c:out value="${bpaApplication.permitCancel.approverRemarks}"
				default="N/A"></c:out>
		</div>
	</div>
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			...
			<c:forEach var="doc"
				items="${bpaApplication.permitCancel.cancelSupportDocs}"
				varStatus="loop">
