...
$(document).ready(function () {
    ...
    var row = '<tr>' +
        ...
        '<td><textarea class="form-control patternvalidation additionalPermitCondition" rows="2" maxlength="500" name="additionalRejectReasonsTemp[{{idx}}].additionalCondition"/></td>';
    ...
    var validator = $("#ocDocumentscrutinyform").validate({
...
function validateDocScrutinyForm(validator) {
    if ($('#ocDocumentscrutinyform').valid()) {
        $('#ocDocumentscrutinyform').find(':input', ':select', ':textarea').each(function () {
