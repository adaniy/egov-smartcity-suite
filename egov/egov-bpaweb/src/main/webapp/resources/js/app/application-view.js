				...
				function() {
					...
					if ($('#wfstateDesc').val() == 'LP Created') {
						...
						|| $('#wfstateDesc').val() == 'Rejection initiated by clerk' 
							|| $('#wfstateDesc').val() == 'Initiated for noc verification') {
						$("#approverDetailBody").hide();
                    ...
                    } else if ($('#captureNocVerifyRemarks').val() === 'true') {
                        tabfocus = '#noc-verify-remarks';
					...
					function loadAmenities() {
						...
						if (seviceTypeName == 'Huts and Sheds') {
							...
							amenities.push('Tower Construction Height');
						} else if (seviceTypeName == 'Pole Structures') {
							amenities.push('Pole Structures');
							amenities.push('Pole Structures Height');
						} else if(seviceTypeName == 'Sub-Division of plot/Land Development'){
							amenities.push('Sub-Division of plot/Land Development');
				        }
					...
					function getTemplateComplie(value, isFirstPosition) {
						...
						case "Tower Construction Height":
			                templateStr=$('#towerPoleHeight-view-template').html();
			                break;
						...
						case "Sub-Division of plot/Land Development":
			                templateStr=$('#developArea-view-template').html();
			                break;
						}
