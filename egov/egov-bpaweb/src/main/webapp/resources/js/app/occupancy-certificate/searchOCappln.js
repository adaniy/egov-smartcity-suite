								...
								.dataTable(
										{
                                            ...
                                            "order": [[1, 'asc']],
											ajax : {
												url : "/bpa/application/occupancy-certificate/search",
												type : "POST",
												beforeSend : function() {
													$('.loader-class')
															.modal(
                                                ...
                                                data: function (args) {
                                                    return {
                                                        ...
                                                        "occupancyCertificateNumber": $("#occupancyCertificateNumber").val(),
													...
													},
													{
														...
														"render" : function(
															...
															if (row.status == 'Approved' && row.isFeeCollected) {
																...
																return ('<select class="dropchange" style="width:160px;font-size: small">'+commonOptions+'<option  value='
																		+ permitorderurl
																		+ row.applicationNumber + '>Generate Occupancy Certificate</option></select>');
