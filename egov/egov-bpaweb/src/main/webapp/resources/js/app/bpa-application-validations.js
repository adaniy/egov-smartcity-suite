...
$(document).ready(function() {
    ...
    //Validate lArea of land proposed to be developed of sub-division/land development service
    $(document).on('blur', '#developedLandArea', function(evt) {
    	var developedLandArea = $(this).val();
    	var plotArea = $('#extentinsqmts').val();
    	if(plotArea && developedLandArea && parseFloat(developedLandArea) > parseFloat(plotArea)) {
    		bootbox.alert('Area of land proposed to be developed should be less than or equal to the extent of land')
    		$(this).val('');
    	}
    });
    ...
    function loadAmenities(){
        ...
        if($( "#serviceType option:selected" ).text() == 'Huts and Sheds'){
            formInputFields.push('Huts and Sheds');
        } else if($( "#serviceType option:selected" ).text() == 'Tower Construction'){
        	formInputFields.push('Tower Construction');
            formInputFields.push('Tower Construction Height');
        } else if($( "#serviceType option:selected" ).text() == 'Pole Structures'){
        	formInputFields.push('Pole Structures');
            formInputFields.push('Pole Structures Height');
        } else if($( "#serviceType option:selected" ).text() == 'Sub-Division of plot/Land Development'){
            formInputFields.push('Sub-Division of plot/Land Development');
        }

        $.each($("#applicationAmenity option:selected"), function(idx){
            formInputFields.push($(this).text());
        });


        var result="";
        $.each(formInputFields, function(idx, value){
    ...
    function getTemplateComplie(value, isFirstPosition){
        ...
        switch(value) {
            ...
            case "Tower Construction":
                ...
                break;
            case "Tower Construction Height":
                templateStr=$('#towerPoleHeight-template').html();
                break;
            case "Pole Structures":
                templateStr=$('#poles-template').html();
                break;
            case "Pole Structures Height":
                templateStr=$('#towerPoleHeight-template').html();
                break;
            case "Huts and Sheds":
                templateStr=$('#sheds-template').html();
                break;
            case "Sub-Division of plot/Land Development":
                templateStr=$('#developArea-template').html();
                break;
        }
