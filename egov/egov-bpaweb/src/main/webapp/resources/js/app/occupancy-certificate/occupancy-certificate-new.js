...
jQuery(document).ready(function ($) {
    ...
    $('#ocSave').click(function (e) {
        ...
        if (validateFormOnSave(button, validator)) {
            bootbox
                .confirm({
                    message: 'Do you really want to save the application. Are you sure ?',
                    buttons: {
                        'cancel': {
                            label: 'No',
    ...
    $('#ocSubmit').click(function (e) {
        ...
        if (validateFormOnSubmit(button, validator)) {
            bootbox
                .confirm({
                    message: 'Do you really want to submit the application, once application is submitted you are not allowed to modify date of construction start and completion details and other application details. Please make sure entered details are correct. Are you sure ?',
                    buttons: {
                        'cancel': {
                            label: 'No',
                            className: 'btn-danger'
